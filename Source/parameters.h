...
struct parameters
{
    parameters(): forwardFFT(fftOrder)
    {
    ...
    float circleWeight = 0.0f;
    const float circleWeightMax = 3.0f;
    float circleSpeedMod = 0.0f;
    const float circleSpeedMax = 0.01f;
    float circleSlideMod = 0.0f;
    const float circleSlideMax = 1.0f;
    float circlePullMod = 0.0f;
    const float circlePullMax = 1.0f;
